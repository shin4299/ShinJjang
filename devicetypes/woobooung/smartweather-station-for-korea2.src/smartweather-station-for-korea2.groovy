 ...
 */
metadata {
   definition (name: "SmartWeather Station For Korea2", namespace: "WooBooung", author: "Booung", ocfResourceType: "x.com.st.airqualitylevel") {
   ...
   preferences {
      ...
      input "stationName", "text", title: "Station name", description: "관측소 이름을 입력해주세요", required: true
        input "refreshRateMin", "enum", title: "Update interval", defaultValue: 60, options:[30: "30 Min", 60 : "1 Hour", 180 :"3 Hour", 360: "6 Hour", 720: "12 Hour", 1440: "Daily"], displayDuringSetup: true
   }
            ...
            httpGet(params) {resp ->
                ...
                if (resp.status == 200) {
                    ...
                    if( resp.data.list[0].khaiValue != "-" ) {
                       ...
                       sendEvent(name:"data_time", value: " " + resp.data.parm.stationName + " 대기질 수치: ${khai}\n 측정 시간: " + resp.data.list[0].dataTime, isStateChange: true)
